...
if __name__ == '__main__':
	...
	plot_fret_eff_hist(pl.subplot(221), F_Dem_Dexc, F_Aem_Dexc, 0.0)
	plot_fret_eff_hist(pl.subplot(222), F_Dem_Dexc, F_Aem_Dexc, 1.0)
	plot_fret_eff_hist(pl.subplot(223), F_Dem_Dexc, F_Aem_Dexc, 1.5)
	plot_fret_eff_hist(pl.subplot(224), F_Dem_Dexc, F_Aem_Dexc, 2.0)
